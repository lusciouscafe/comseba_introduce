...
const moveComsebaYoutube = () => {
  window.location.href =
    "http://www.youtube.com/channel/UCzSgCAZF86AE-dk9An7kg";
};

const moveComsebaInstagram = () => {
  window.location.href = "http://www.instagrem.com/comseba_1992";
};

const skillDescriptionContent = {
  C: [
    "C언어 화경, C언어 개요 및 특징, 컴파일러 사용법, C언어 기본문법",
  ...
  JAVA: [
    ...
    "각 컴포넌트별 사용방법",
    "이벤트의 종류 및 적용 방법",
    "Window, Action, Mouse, Mousemtion",
    "Key, Focus, Item 이벤트",
  ],
  Python: [
    "파이썬의 개요, 특징 알아보기",
